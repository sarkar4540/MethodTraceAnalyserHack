...
public class diff_match_patch {
   ...
   * @return LinkedList of Diff objects.
   */
  public LinkedList<Diff> diff_bisectSplit(String text1, String text2,
   ...
   */
  public String diff_linesToCharsMunge(String text, List<String> lineArray,
  ...
  public Pattern BLANKLINEEND
      = Pattern.compile("\\n\\r?\\n\\Z", Pattern.DOTALL);
  public Pattern BLANKLINESTART
      = Pattern.compile("\\A\\r?\\n\\r?\\n", Pattern.DOTALL);
